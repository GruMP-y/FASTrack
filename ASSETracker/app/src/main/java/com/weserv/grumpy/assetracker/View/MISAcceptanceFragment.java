 ...
 */
public class MISAcceptanceFragment extends BaseFragment {
    ...
    private void acceptAssignment(String assetTag){
        ...
        try {
            ...
            if (theJSONAsset != null) {
                ...
                this.displayToast("Asset not found.");
            }
        }
        catch(Exception ex){
    ...
    public void update(Observable observable, Object o) {
        ...
        try {
            if (observable instanceof Asset) {
                if (o == null) {
                    this.displayToast("Accept successful.");
                } else {
                    this.displayToast("Error accepting asset.");
                }
            }
            ((MainScreenActivity)currentContext).loadData();
        }
        catch(Exception ex){
            Log.d(Common.LOGNAME,ex.toString());
        }
