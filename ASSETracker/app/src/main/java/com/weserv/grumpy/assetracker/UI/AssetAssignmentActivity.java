...
public class AssetAssignmentActivity extends AppCompatActivity
        implements RequestResponseCallback, BarcodeScannerListener,JSONObjectResponseCallback{
    ...
    public void onResponse(String response) {
        ...
        if (response.equals("\"SUCCESSFUL\"")) {
            Log.d("ASSET_ASSIGN", "Successful!");
            Toast.makeText(getApplicationContext(), "Asset Assignment Successful!!", Toast.LENGTH_LONG).show();
            finish();
        } else {
            Log.d("ASSET_ASSIGN", "Failed!");
            Toast.makeText(getApplicationContext(), "Asset Assignment Failed!" + response, Toast.LENGTH_LONG).show();
        }
    }

    @Override
    public void onErrorResponse(VolleyError error) {
        Log.d("ASSET_ASSIGN", "Registration Error!");
        Toast.makeText(getApplicationContext(), "Asset Assignment Failed!!", Toast.LENGTH_LONG).show();
    }

    @Override
    public void onJSONResponse(JSONObject response) {
        Log.d("LOAD_DATA", "Loading Employee Detail... Completed!");
        Log.d("LOAD_DATA", response.toString());
   ...
   @Override
    public void onJSONErrorResponse(VolleyError error) {
        Log.d("LOAD_DATA", "Loading DATA... Error!");
