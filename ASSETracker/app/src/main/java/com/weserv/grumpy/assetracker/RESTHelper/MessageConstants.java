...
public class MessageConstants {
    ...
    public final static String ASSIGNMENT_MESSAGE_CAT_PUT_APPROVE_TRANSFER="Transfer/Approve";
    public final static String ASSIGNMENT_MESSAGE_CAT_PUT_DENY_TRANSFER="Transfer/Deny";
    ...
    public final static String URL_TEMPLATE = "http://%s/api/%s/%s";
    public final static String URL_TEMPLATE_WITH_PARAM = "http://%s/api/%s/%s/%s";
